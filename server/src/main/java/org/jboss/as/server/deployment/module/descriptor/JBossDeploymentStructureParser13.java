 ...
 */
public class JBossDeploymentStructureParser13 implements XMLElementReader<ParseResult> {
    ...
    enum Element {
        ...
        static {
            ...
            elementsMap.put(new QName(NAMESPACE_1_3, "jboss-deployment-structure"), Element.JBOSS_DEPLOYMENT_STRUCTURE);
            elementsMap.put(new QName(NAMESPACE_1_3, "ear-subdeployments-isolated"), Element.EAR_SUBDEPLOYMENTS_ISOLATED);
            elementsMap.put(new QName(NAMESPACE_1_3, "ear-exclusions-cascaded-to-subdeployments"), Element.EAR_EXCLUSIONS_CASCADED_TO_SUBDEPLOYMENTS);
            elementsMap.put(new QName(NAMESPACE_1_3, "deployment"), Element.DEPLOYMENT);
            elementsMap.put(new QName(NAMESPACE_1_3, "sub-deployment"), Element.SUB_DEPLOYMENT);
            elementsMap.put(new QName(NAMESPACE_1_3, "module"), Element.MODULE);
            elementsMap.put(new QName(NAMESPACE_1_3, "dependencies"), Element.DEPENDENCIES);
            elementsMap.put(new QName(NAMESPACE_1_3, "resources"), Element.RESOURCES);
            elementsMap.put(new QName(NAMESPACE_1_3, "resource-root"), Element.RESOURCE_ROOT);
            elementsMap.put(new QName(NAMESPACE_1_3, "path"), Element.PATH);
            elementsMap.put(new QName(NAMESPACE_1_3, "exclude-subsystems"), Element.EXCLUDE_SUBSYSTEMS);
            elementsMap.put(new QName(NAMESPACE_1_3, "exports"), Element.EXPORTS);
            elementsMap.put(new QName(NAMESPACE_1_3, "imports"), Element.IMPORTS);
            elementsMap.put(new QName(NAMESPACE_1_3, "include"), Element.INCLUDE);
            elementsMap.put(new QName(NAMESPACE_1_3, "exclude"), Element.EXCLUDE);
            elementsMap.put(new QName(NAMESPACE_1_3, "exclusions"), Element.EXCLUSIONS);
            elementsMap.put(new QName(NAMESPACE_1_3, "include-set"), Element.INCLUDE_SET);
            elementsMap.put(new QName(NAMESPACE_1_3, "exclude-set"), Element.EXCLUDE_SET);
            elementsMap.put(new QName(NAMESPACE_1_3, "filter"), Element.FILTER);
            elementsMap.put(new QName(NAMESPACE_1_3, "transformers"), Element.TRANSFORMERS);
            elementsMap.put(new QName(NAMESPACE_1_3, "transformer"), Element.TRANSFORMER);
            elementsMap.put(new QName(NAMESPACE_1_3, "local-last"), Element.LOCAL_LAST);
            elementsMap.put(new QName(NAMESPACE_1_3, "module-alias"), Element.MODULE_ALIAS);
            elementsMap.put(new QName(NAMESPACE_1_3, "subsystem"), Element.SUBSYSTEM);
            elementsMap.put(new QName(NAMESPACE_1_3, "system"), Element.SYSTEM);
            elementsMap.put(new QName(NAMESPACE_1_3, "paths"), Element.PATHS);
                ...
                case XMLStreamConstants.START_ELEMENT: {
                    ...
                    switch (element) {
                        ...
                        case EXCLUDE_SUBSYSTEMS:
                            parseExcludeSubsystem(reader, moduleSpec);
                            break;
                        default:
                            throw unexpectedContent(reader);
                    }
