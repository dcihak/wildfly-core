...
public class JBossDeploymentStructureParser12 implements XMLElementReader<ParseResult> {
    ...
    public static final String NAMESPACE_1_2 = "urn:jboss:deployment-structure:1.2";

    public static final JBossDeploymentStructureParser12 INSTANCE = new JBossDeploymentStructureParser12();
    ...
    enum Element {
        ...
        static {
            ...
            elementsMap.put(new QName(NAMESPACE_1_2, "sub-deployment"), Element.SUB_DEPLOYMENT);
            elementsMap.put(new QName(NAMESPACE_1_2, "module"), Element.MODULE);
            elementsMap.put(new QName(NAMESPACE_1_2, "dependencies"), Element.DEPENDENCIES);
            elementsMap.put(new QName(NAMESPACE_1_2, "resources"), Element.RESOURCES);
            elementsMap.put(new QName(NAMESPACE_1_2, "resource-root"), Element.RESOURCE_ROOT);
            elementsMap.put(new QName(NAMESPACE_1_2, "path"), Element.PATH);
            elementsMap.put(new QName(NAMESPACE_1_2, "exclude-subsystems"), Element.EXCLUDE_SUBSYSTEMS);
            elementsMap.put(new QName(NAMESPACE_1_2, "exports"), Element.EXPORTS);
            elementsMap.put(new QName(NAMESPACE_1_2, "imports"), Element.IMPORTS);
            elementsMap.put(new QName(NAMESPACE_1_2, "include"), Element.INCLUDE);
            elementsMap.put(new QName(NAMESPACE_1_2, "exclude"), Element.EXCLUDE);
            elementsMap.put(new QName(NAMESPACE_1_2, "exclusions"), Element.EXCLUSIONS);
            elementsMap.put(new QName(NAMESPACE_1_2, "include-set"), Element.INCLUDE_SET);
            elementsMap.put(new QName(NAMESPACE_1_2, "exclude-set"), Element.EXCLUDE_SET);
            elementsMap.put(new QName(NAMESPACE_1_2, "filter"), Element.FILTER);
            elementsMap.put(new QName(NAMESPACE_1_2, "transformers"), Element.TRANSFORMERS);
            elementsMap.put(new QName(NAMESPACE_1_2, "transformer"), Element.TRANSFORMER);
            elementsMap.put(new QName(NAMESPACE_1_2, "local-last"), Element.LOCAL_LAST);
            elementsMap.put(new QName(NAMESPACE_1_2, "module-alias"), Element.MODULE_ALIAS);
            elementsMap.put(new QName(NAMESPACE_1_2, "subsystem"), Element.SUBSYSTEM);
            elementsMap.put(new QName(NAMESPACE_1_2, "system"), Element.SYSTEM);
            elementsMap.put(new QName(NAMESPACE_1_2, "paths"), Element.PATHS);
    ...
    private JBossDeploymentStructureParser12() {
    }
